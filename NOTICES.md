...
Contact for Code of Conduct issues or inquires: areyoufeelingitnowmrkrebs@gmail.com


## License Acceptance

Per Community Specification License 1.0 Section 2.1.3.3, Licensees may indicate their acceptance of the Community Specification License by issuing a pull request to the [Specification repository’s](https://github.com/areyoufeelingitnowmrkrebs/sfsh) NOTICES.md file, including the Licensee’s name, authorized individuals' names, and repository system identifier (e.g. GitHub ID), and specification version.
...
Licensee’s name: Nathaniel Krebs

Authorized individual and system identifier: areyoufeelingitnowmrkrebs
